...
export default function App() {
  ...
  return (
    <div className="flex min-h-[100dvh] justify-center bg-black lg:items-center lg:py-10">
      {/* Desktop only (≥1000px): phone bezel — a thick black "case" around the frame. */}
      <div className="relative lg:rounded-[48px] lg:bg-black lg:p-3 lg:shadow-[0_30px_80px_rgba(0,0,0,0.6),0_0_0_2px_rgba(255,255,255,0.04)_inset]">
        {/* Mobile frame:
            - Below 1000px: fluid width up to 470px, full viewport height.
            - At ≥1000px: fixed 470x850 phone frame inside the bezel.
        ...
        <div className="relative h-[100dvh] w-full max-w-mobile overflow-hidden bg-surface-elevated shadow-2xl lg:h-phone lg:w-[470px] lg:max-w-none lg:rounded-[36px]">

  ...
  return (
    <div className="flex min-h-[100dvh] justify-center bg-black lg:items-center lg:py-6">
      ...
      <div className="relative lg:rounded-[48px] lg:bg-black lg:p-3 lg:shadow-[0_30px_80px_rgba(0,0,0,0.6),0_0_0_2px_rgba(255,255,255,0.04)_inset]">
        {/* Mobile frame:
            - Below 1000px: full viewport (100dvh handles iOS Safari chrome), fluid width up to 470px.
        ...
        <div className="relative h-[100dvh] w-full max-w-mobile overflow-hidden bg-surface-elevated shadow-2xl lg:h-[min(850px,calc(100dvh-72px))] lg:w-[470px] lg:max-w-none lg:rounded-[36px]">
